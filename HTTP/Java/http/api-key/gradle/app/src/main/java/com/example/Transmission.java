...
public class Transmission {
	public static void main(String args[]) {
        String apiKey = "1000.****************************"; // Replace with your API key
        try {
        	URL url = new URL("https://campaigns.zoho.com/emailapi/v2/transmission");
            ...
            urlConnection.setRequestProperty("Authorization", "Zoho-zapikey " + apiKey);
